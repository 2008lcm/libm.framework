#
#  Be sure to run `pod spec lint libm.framework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/2008lcm/libm.framework.git", :tag => "#{spec.version}" }
  ...
  # spec.public_header_files = "libm.framework/Headers/*.h"
